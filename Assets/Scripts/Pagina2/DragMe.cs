...
public class DragMe : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	...
	private Vector3 mOriginalIconScale;
	public void EnlargeIcon (float scale)
	{
		m_DraggingIcon.transform.localScale = scale * mOriginalIconScale;
	}
	...
	{
		m_DraggingIcon.transform.localScale = mOriginalIconScale;
	}
}
